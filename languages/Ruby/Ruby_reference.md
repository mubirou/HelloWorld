...
* Hello,world! （[Linux](https://github.com/vvestvillage/HelloWorld/blob/master/languages/Ruby/Ruby_linux.md) / [macOS](https://github.com/vvestvillage/HelloWorld/blob/master/languages/Ruby/Ruby_mac.md) / [Windows](https://github.com/vvestvillage/HelloWorld/blob/master/languages/Ruby/Ruby_win.md)）
* [データ型](#データ型)
* [データ型の操作](#データ型の操作)
* [クラス](#クラス)
...
```
#test.rb
MY_NAME = "vvestvillage" #先頭はアルファベットの大文字にしなければならない
puts(MY_NAME) #"vvestvillage"
...
#=======================================
class MyClass
  MY_NAME = "vvestvillage" #先頭はアルファベットの大文字
  def initialize(init=0)
    puts(MY_NAME) #"vvestvillage" #クラス内でのアクセス方法
  end
end
...
# 実行（クラス名::クラス定数でアクセス）
#=======================================
puts(MyClass::MY_NAME) #"vvestvillage"（外からのアクセス方法）
